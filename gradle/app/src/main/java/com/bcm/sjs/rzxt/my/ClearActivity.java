...
import com.bcm.sjs.rzxt.Adapter.ContactAdapter;
import com.bcm.sjs.rzxt.DB.TaskPro;
import com.bcm.sjs.rzxt.R;
import com.bcm.sjs.rzxt.TaskInfoActivity;
        ...
        switch (v.getId()) {
            ...
            case R.id. btn_sreach_over_event:
                ...
                if (TextUtils.isEmpty(overEventinfo) ) {
                    ...
                    contacts.clear();
                    contacts  = repo.getSreachManageCache(overEventinfo,userAccount);
