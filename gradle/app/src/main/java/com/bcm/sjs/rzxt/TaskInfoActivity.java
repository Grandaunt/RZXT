            ...
            if (f.exists()) {
                ...
                x.http().post(params, new Callback.CommonCallback<String>() {
                    ...
                    public void onFinished() {
                       ...
                       if(uploadi==type7img.length+type7img.length+type7img.length){
        ...
        for (int imagei = 0; imagei < type9img.length-1; imagei++) {
            ...
            if (f.exists()) {
                ...
                x.http().post(params, new Callback.CommonCallback<String>() {
                    ...
                    public void onFinished() {
                        Log.i(TAG,"uploadi="+uploadi);
                        if(uploadi==type7img.length+type7img.length+type7img.length-3){
                            Log.i(TAG,"uploadi完成 更新 ="+uploadi);
                            mMedialist.mt_status=2+"";
                            mediapro.UpdateStatus(mMedialist);
                        }
                    }
...
//        if(!com_info_memo.getText().toString().equals("")) {
//                RequestParams params = new RequestParams(url);
//                //支持断点续传
//                params.setAutoResume(true);
//                params.setMultipart(true);
